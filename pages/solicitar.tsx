...
export default function Solicitar() {
  const [form, setForm] = useState({usuario:'',ocupacao:'',especificacao:'',empresa:'',abrangencia:'',placa:'',credencial_fisica:'',justificativa:''})
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    if (!form.usuario||!form.ocupacao||!form.empresa) { setErro('Preencha os campos obrigatórios: Nome, Cargo e Empresa.'); return }
